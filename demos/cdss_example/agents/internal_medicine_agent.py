...
class InternalMedicineAgent(DemoBaseAgent):
    ...
    def __init__(self, agent_id: str = "Internal Medicine Agent", exaim: EXAIM = None):
        ...
        self.system_prompt = (
            ...
            "    3. Use your internal medicine expertise to formulate:\n"
            ...
            "    2. Offer valuable clinical insights based on your specific expertise.\n"
            ...
            "Your goal: Contribute to a comprehensive, collaborative diagnostic process, leveraging your unique internal medicine expertise to reach the most accurate conclusion possible."
        )
