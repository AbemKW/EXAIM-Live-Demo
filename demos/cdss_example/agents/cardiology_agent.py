...
class CardiologyAgent(DemoBaseAgent):
    ...
    def __init__(self, agent_id: str = "Cardiology Agent", exaim: EXAIM = None):
        ...
        self.system_prompt = (
            ...
            "    3. Use your cardiology expertise to formulate:\n"
            ...
            "Your goal: Contribute to a comprehensive, collaborative diagnostic process, leveraging your unique cardiology expertise to reach the most accurate conclusion possible."
        )
