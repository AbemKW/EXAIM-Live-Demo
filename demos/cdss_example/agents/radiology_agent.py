...
class RadiologyAgent(DemoBaseAgent):
    ...
    def __init__(self, agent_id: str = "Radiology Agent", exaim: EXAIM = None):
        ...
        self.system_prompt = (
            ...
            "    3. Use your radiology expertise to formulate:\n"
            ...
            "Your goal: Contribute to a comprehensive, collaborative diagnostic process, leveraging your unique radiology expertise to reach the most accurate conclusion possible."
        )
